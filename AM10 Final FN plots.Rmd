...
map_latest <- euro_joined %>% 
  ...
  labs(title = "XXX",subtitle = 'Most Recent(2020/11/24) New Cases per Million in Europe',
...
map_total <- euro_joined %>% 
  ...
  labs(title = 'XXXX',subtitle = "Total Cases per Million in Europe", x='',y=''
