...
poland_1wave <- covid_europe %>% 
  ...
  annotate(geom="text", x = as.Date('2020-04-15'),y = 100,label='First\nLockdown',size=3.5) +
...
uk_2wave  <- covid_europe %>% 
  ...
  annotate(geom ="text", x = as.Date('2020-11-13'),y = 800, label='Second\nLockdown', color = 'black', size = 3.5) +
  annotate(geom = 'text', x = as.Date('2020-10-23'), y = 800, label = 'New\nRestrictions', color = 'black', size = 3.5) + 
...
poland_2wave<- covid_europe %>% 
  ...
  geom_vline(xintercept = as.Date('2020-11-24'), color = 'darkgrey', linetype = 'dashed')+ 
  annotate(geom="text", x = as.Date('2020-10-30'),y = 800,label='Second\nLockdown', size = 3.5) +
  annotate(geom="text", x = as.Date('2020-10-16'),y = 800,label='New\nRestrictions', size = 3.5) +
...
sweden_2wave <- covid_europe %>% 
  ...
  #new restrictions
  geom_vline(xintercept = as.Date('2020-10-09'), color = 'darkgrey', linetype = 'dashed')+ #add dashed line
  annotate(geom="text", x = as.Date('2020-10-20'),y = 800,label='\nNew\nRestrictions', size = 3.5) +
...
france_2wave <- covid_europe %>% 
  ...
  annotate(geom="text", x = as.Date('2020-11-10'),y = 1000,label='Second\nLockdown',size=3.5)+
